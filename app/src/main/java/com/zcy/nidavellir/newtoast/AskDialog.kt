...
inline fun askDialog(dsl: AskDialog.() -> Unit): AskDialog {
    return AskDialog.newInstance().apply(dsl)
}
...
open class AskDialog : BaseFragmentDialog() {
    ...
    var mColor: Int = App.instance.color(R.color.colorAccent)
    var mCancelText: String = App.instance.string(R.string.cancel)
    var mSureText: String = App.instance.string(R.string.sure)
